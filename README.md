...
## التثبيت على الهاتف أو الكمبيوتر

- على Chrome / Edge (كمبيوتر أو Android): سيظهر زر `تثبيت التطبيق` في الشريط العلوي عند توفر التثبيت.
- على iPhone (Safari): استخدم زر المشاركة ثم `Add to Home Screen`.
- بعد التثبيت سيعمل التطبيق بوضع مستقل (مثل تطبيق حقيقي).
