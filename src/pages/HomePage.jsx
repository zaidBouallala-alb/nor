...
/* ─── daily ayah pool ─── */
const dailyAyahs = [
  { text: 'إِنَّ مَعَ ٱلْعُسْرِ يُسْرًا', ref: 'الشرح : ٦' },
  { text: 'وَمَن يَتَوَكَّلْ عَلَى ٱللَّهِ فَهُوَ حَسْبُهُ', ref: 'الطلاق : ٣' },
  { text: 'وَٱذْكُرُوا۟ ٱللَّهَ كَثِيرًا لَّعَلَّكُمْ تُفْلِحُونَ', ref: 'الجمعة : ١٠' },
  { text: 'رَبِّ ٱشْرَحْ لِى صَدْرِى وَيَسِّرْ لِىٓ أَمْرِى', ref: 'طه : ٢٥-٢٦' },
  { text: 'فَٱذْكُرُونِىٓ أَذْكُرْكُمْ', ref: 'البقرة : ١٥٢' },
  { text: 'وَلَسَوْفَ يُعْطِيكَ رَبُّكَ فَتَرْضَىٰٓ', ref: 'الضحى : ٥' },
  { text: 'ٱللَّهُ لَآ إِلَـٰهَ إِلَّا هُوَ ٱلْحَىُّ ٱلْقَيُّومُ', ref: 'البقرة : ٢٥٥' },
]
...
const dailyTips = [
  ...
  'التسبيح بعد الصلاة ٣٣ مرة من أحب الأعمال إلى الله.',
]
